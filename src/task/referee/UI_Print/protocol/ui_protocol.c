...
uint8_t client_send_char(ext_client_custom_character_t data)
{
    ...
    data_header.sender_ID = client_info.robot_id;
    data_header.receiver_ID = client_info.client_id;
    client_tx_buf[7] = 0x10;
    client_tx_buf[8] = 0x01;
    client_tx_buf[9] = client_info.robot_id & 0xFF;
    client_tx_buf[10] = (client_info.robot_id >> 8) & 0xFF;
    client_tx_buf[11] = client_info.client_id & 0xFF;
    client_tx_buf[12] = (client_info.client_id >> 8) & 0xFF;
    memcpy(&client_tx_buf[13], &data.grapic_data_struct, 15);
