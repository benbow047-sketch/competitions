 ...
 * @version 0.2
 * @date 2022-11-01
 * @copyright Copyright (c) 2022 Embedded Framework
 *
 */
...
typedef struct
{
    ...
    int16_t  speed_rad;       // rpm = 角速度（rad/s） ×60/2π
...
void dji_supercap_update_frame(uint8_t d0, uint8_t d1, uint8_t d2, uint8_t d3,uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7);
